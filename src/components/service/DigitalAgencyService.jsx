...
const DigitalAgencyService = () => {
  useEffect(() => {
    if (typeof window !== "undefined") {
      document
        .querySelector(".service__list a:nth-child(1)")
        .classList.add("active");
      document
        .querySelectorAll(".service__list a:nth-child(1) ~ a")
        .forEach(function (el) {
      ...
      document.querySelectorAll(".service__item").forEach(function (el) {
        el.addEventListener("mousemove", function (e) {
          ...
          document
            .querySelector(".service__img.img-" + service_id)
            .classList.add("active");
          document
            .querySelectorAll(".service__img:not(.img-" + service_id + ")")
            .forEach(function (el) {
              el.classList.remove("active");
            });

          document
            .querySelector(".shapes.shape-box-" + service_id)
            .classList.add("current");
          document
            .querySelectorAll(".shapes:not(.shape-box-" + service_id + ")")
            .forEach(function (el) {
        ...
        el.addEventListener("mouseout", function (e) {
          var service_id = this.getAttribute("data-service");
          document
            .querySelector(".service__list a:nth-child(" + service_id + ")")
            .classList.add("active");
          document
            .querySelectorAll(
              ".service__list a:not(:nth-child(" + service_id + "))"
            )
            .forEach(function (el) {
              el.classList.remove("active");
            });
            ...
            <div className="row">
              <div className="col-xxl-4 col-xl-4 col-lg-0 col-md-0">
                <div className="service__img-wrapper">
                  ...
                  <span className="shapes shape-box-1 current"></span>
                  <span className="shapes shape-box-2"></span>
                  <span className="shapes shape-box-3"></span>
                  <span className="shapes shape-box-4"></span>
                </div>
              </div>
